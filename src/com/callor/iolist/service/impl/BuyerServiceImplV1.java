 ...
 * 		BuyerDao buyerDao;
 * 객체의 초기화 : 선언된 객체를 통하여 변수, method 에 접근할 수 있도록
 * 		하는 조치
...
public class BuyerServiceImplV1 implements BuyerService {
	...
	public BuyerServiceImplV1() {
		...
		// new 생성자를 사용하지 않고
		// SqlSession 의 getMapper() method 를 통하여
...
//		System.out.println("고객정보" + buyerDto);
	...
	// BuyerDao.selectAll() 실행에서 전체 Buyer List 출력하기
	@Override
